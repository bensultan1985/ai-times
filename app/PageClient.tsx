        ...
        <aside className="border rounded-md p-2 bg-zinc-50/60">
          ...
          <div className="p-2">
            ...
            <p>
              ...
              delivering content via an automated, templated pipeline. Each day
              at midnight, new articles are generated and published
              automatically. No human assistance required.
            </p>
          </div>
        </aside>
